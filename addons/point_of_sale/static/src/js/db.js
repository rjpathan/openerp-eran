    ...
    module.PosLS = instance.web.Class.extend({
        ...
        add_products: function(products){
            ...
            for(var i = 0, len = products.length; i < len; i++){
                ...
                if(product.code && product.sale_journal){
                    this.custom_product_by_code[product.code.toLowerCase()] = product;
                }
                if(product.ean13){
        ...
        /* For customer Selection by kiran
         */
        ...
        get_custom_product_by_code: function(code){
            return this.custom_product_by_code[code];
        },
