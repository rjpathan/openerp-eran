    ...
    module.PaypadButtonWidget = module.PosBaseWidget.extend({
        ...
        renderElement: function() {
            ...
            this.$el.click(function(){
                ...
                //Code added to open Credit Memo window by Kiran.P
                
                if (self.cashRegister.get('journal').code.toLowerCase() === 'cmemo'){ // To Enter Memo reference
                	self.pos_widget.screen_selector.show_popup('credit_reference');
                }
                else if (self.cashRegister.get('journal').code.toLowerCase() === 'gcpay'){ // To Enter Gift Card Reference
                	self.pos_widget.screen_selector.show_popup('giftcard_redeem');
                }
                else{
    ...
    module.OrderWidget = module.PosBaseWidget.extend({
        ...
        set_value: function(val) {
        	...
        	if (order.get('orderLines').length !== 0) {
              ...
              //  alert((val))
               // alert(val!=='remove')
                //if (order.getSelectedLine().product.get('sale_journal')){
                //	numstate=self.numpadState;
                //	self.numpadState.reset();
                //	self.set_numpad_state(numstate);	
                ...
                //else{
	                if( mode === 'quantity'){
	                    ...
	                    res=order.getSelectedLine().set_quantity(val);
...
// ---------- Main Point of Sale Widget ----------
    ...
    module.PosWidget = module.PosBaseWidget.extend({
        ...
        build_widgets: function() {
            ...
            this.credit_reference = new module.CreditMemoReferenceWidget(this, {});
            this.credit_reference.appendTo($('.point-of-sale'));
            
            this.giftcard_redeem = new module.GiftCardRedeemWidget(this, {});
            this.giftcard_redeem.appendTo($('.point-of-sale'));
            
            this.money_out = new module.MoneyoutPopupWidget(this, {});
            this.money_out.appendTo($('.point-of-sale'));
            
            this.put_money = new module.MoneyPopupWidget(this, {});
            this.put_money.appendTo($('.point-of-sale'));
...
//            this.customername.appendTo(this.$('#rightheader'));
            ...
            this.select_customer_button = new module.HeaderButtonWidget(this,{
                label:'Einlagen',
                action: function(){ self.screen_selector.show_popup('put_money'); },
            });
            this.select_customer_button.appendTo(this.$('#rightheader'));
            
            this.select_customer_button = new module.HeaderButtonWidget(this,{
                label:'Ausgaben',
                action: function(){ self.screen_selector.show_popup('money_out'); },
            });
            this.select_customer_button.appendTo(this.$('#rightheader'));
            ...
            this.screen_selector = new module.ScreenSelector({
                ...
                popup_set:{
                    ...
                    'credit_reference':this.credit_reference,
                    'giftcard_redeem':this.giftcard_redeem,
                },
